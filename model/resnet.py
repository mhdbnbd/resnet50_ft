# edited https://github.com/huitangtang/SRDC-CVPR2020/blob/master/models/resnet.py
...
def resnet50(num_classes):
    ...
    """
    pretrained=True
    model = ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, num_neurons=128)
    if pretrained:
...
# args : pretrained(true) , architecture(resnet50), neurons(128)
def resnet(num_classes):
  arch='resnet50'
  print("==> creating model '{}_{}' ".format(arch, num_classes))
  if arch == 'resnet50':
